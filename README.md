...
- layout/index.tsx 中添加 `{props.viteReactScript}` 相关代码 参考该[文件](hhttps://github.com/ykfe/ssr/blob/dev/example/midway-react-ssr/web/components/layout/index.tsx#L27)
